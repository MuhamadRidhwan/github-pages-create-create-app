...
export const CallForPapers = () => (
  <div>
  <Helmet>
    <title>The 6th International Conference on Soft Computing in Data Science 2021 (SCDS2021) - Call For Papers</title>
    <meta name="description" content="The 6th International Conference on Soft Computing in Data Science (SCDS) 2021 that will be held from 2 - 3 November 2021" />
    ...
    <p style={{ textAlign:'justify'}}>The 6th International Conference on Soft Computing in Data Science (SCDS) 2021 that will be held from 2 - 3 November 2021 virtually. With the advancement in computer technology, 
        ...
        business and finance. SCDS2021 aims to provide 
        ...
        is a need to transfer knowledge and technology to industrial applications to solve real-world problems. SCDS2021 have invited renowned international and local keynote 
    ...
    <p style={{ textAlign:'justify'}}>SCDS2021 aims to attract researchers who are actively engaged both in theoretical and practical aspects of soft computing in data science. 
