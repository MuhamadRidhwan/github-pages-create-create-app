...
export const Publication = () => (
  <div>
  <Helmet>
    <title>The 6th International Conference on Soft Computing in Data Science 2021 (SCDS2021) - Publication</title>
  </Helmet>
    ...
    <h3>Proceeding</h3>
    <p style={{ textAlign:'justify'}}>All accepted and registered papers of SCDS2021 will be submitted to be indexed in the renowned series of &quot;Communications 
